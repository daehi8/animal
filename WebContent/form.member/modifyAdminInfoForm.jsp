...
A:visited {text-decoration:none;color:#330066;}
	...
	<%
		...
		MemberDTO dto = dao.adminViewInfo(id);
...
<body>
	<div class="">
		...
		<div>
			...
			<hr class="">
			<form name="modify" method="post" action="/animal/pro.member/modifyAdminInfoPro.jsp" onsubmit="return sendit();">
				<table class="">
					<tr>
						<td class="" colspan="3">	
                			...
                			<tr>
                    			...
                    			<td colspan="2">
                        			...
                        			<input type="hidden" id="email3" name="email3" />
                       				<select  name="emailselect" required="required" value="<%=dto.getEmail2()%>">
				...
				<tr>
					...
					<hr class="">
            	 		...
            	 		<input class="" type="button" value="취소" onclick="location.href = '/animal/form.member/loginAdminForm.jsp'">
					</td>	
				</tr>	
			</table>
		 </form>
	...
	function sendit() {	
		...
		if (document.modify.mem_password.value.length<4 || document.modify.mem_password.value.length>30) {
