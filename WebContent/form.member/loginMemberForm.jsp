...
<body>
	...
	<%
		...
		String matched = (String)session.getAttribute("matched");
			if(matched!=null){
				response.sendRedirect("/animal/form.member/modifyMemberInfoForm.jsp");
	...
	<div class="">
		<div class="">
			...
			<font class="">&nbsp;<%=session.getAttribute("memId") %>님 &nbsp; </font>
		</div>
		<div class="">
		</div>
		<div class="">
			<table class="">
    			...
    			<tr>
	      			<%--<td class="profile" rowspan="3"><img style ="width:100px; height:100px"></td>--%>
	      			<td>이메일</td>
		...
		<div class="">
			<%-- <div class="">
			    ...
			    <%--<div class="">
     			...
     			<div>
     			 	<input type="button" class="" id="admin" value="관리자화면" name="admin" onclick="admin()">										
     			</div>--%>										
		</div>
	</div>  														
</body>
