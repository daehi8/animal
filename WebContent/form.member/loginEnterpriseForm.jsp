...
<body>
	...
	<%
		...
		String matched = (String)session.getAttribute("matched");
			if(matched!=null){
				response.sendRedirect("/animal/form.member/modifyEnterpriseInfoForm.jsp");
	...
	<div class="">
		...
		<div class="">
			<table class="">
    	 		<tr>
    	 			<td>이름</td>
		  			<td class="table1" colspan="3"><%=dto.getMem_name()%>님</td>
        		</tr>
    			<tr>
        	...
        	<div class="">
					<input class="" type="button" id="mypage" value="정보 변경" onclick="window.open('/animal/form.popup/checkModify.jsp','window_name','width=600,height=500,location=no,status=no,scrollbars=yes')">
				</div>
		</div>
		<div class="">
			<%--<div class="">
				<div class="">
					<input class="" type="button" value="나의 메일" 
							onclick="location.href = '/animal/form.boardc/myMailForm.jsp'">
     				<input class="" type="button" value="나의 스토리" 
     						onclick="location.href = '/animal/form.boardc/myStoryForm.jsp'">
				...
				<%--<div class="">
					<input class="" type="button" id="mypage" value="정보 변경" onclick="window.open('/animal/form.popup/checkModify.jsp','window_name','width=600,height=500,location=no,status=no,scrollbars=yes')">
			     <div class="">
     				<input class="" type="button" value="프로필변경" 
     						onclick="location.href = '/animal/form.member/modifyMemberProfileForm.jsp'">
     			</div>
     			<div class="">
     				<input class="" type="button" value="동물관리" 
