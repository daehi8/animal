...
A:visited {text-decoration:none;color:#330066;}
	...
	<%
		...
		MemberDTO dto = dao.memberViewInfo(id);
		System.out.print(id);
	%>
...
<body>
	<div class="">
		...
		<div>
			...
			<hr class="">
			<form name="modify" method="post" action="/animal/pro.member/modifyMemberInfoPro.jsp" onsubmit="return sendit();">
				<table class="">
					<tr>
						<td class="" colspan="3">
							...
							<td>
                 		 	...
                 		 	<tr>
                    			<td width="30%" class="font3">닉네임
                   				...
                   				<td>
                   					<input class="" type="button" id="check_nickname" name="check_nickname" value="중복확인"
                			...
                			<tr>
                    			...
                    			<td colspan="2">
                    			<%
                    			if(dto.getMem_gender().equals("M")){
                    				%>
                    				<input type="radio" id="mem_gender" name="mem_gender" value="M" checked >남성
                        			<input type="radio" id="mem_gender" name="mem_gender" value="W"  >여성
                        			<input type="radio" id="mem_gender" name="mem_gender" value="O"  >기타
                    				<%
                    			}
                    			else if(dto.getMem_gender().equals("W")){
                    				%>
                    				<input type="radio" id="mem_gender" name="mem_gender" value="M"  >남성
                        			<input type="radio" id="mem_gender" name="mem_gender" value="W"  checked>여성
                        			<input type="radio" id="mem_gender" name="mem_gender" value="O"  >기타
                    				<%
                    			}
                    			else if(dto.getMem_gender().equals("O")){
                    				%>
                    				<input type="radio" id="mem_gender" name="mem_gender" value="M"  >남성
                        			<input type="radio" id="mem_gender" name="mem_gender" value="W"  >여성
                			...
                			<tr>
                    			...
                    			<td colspan="2">
                        			...
                        			<input type="text" id="email2" name="email2" size="5" maxlength="20" value="<%=dto.getEmail2()%>">
                	 ...
                	 <tr>
						...
						<tr>
           					<td width="30%" class="font3">생년월일</td>
          				 	<td colspan="2">
				...
				<tr>
					...
					<hr class="">
            	 		...
            	 		<input class="" type="button" value="취소" onclick="location.href = ''">
					</td>	
				</tr>	
			</table>
			</form>
	...
	function sendit() {	
		...
		if (document.modify.mem_password.value != document.modify.mem_passwordc.value) {
    ...
    <script>
    if( #mem_gender == "M" ){
    $("input:radio[name='mem_gender']:radio[value='M']").attr("checked", true);
    } else if {
    $("input:radio[name='mem_gender']:radio[value='W']").attr("checked", true);
    } else {
        $("input:radio[name='mem_gender']:radio[value='O']").attr("checked", true);
    }
    }
    </script>
</body>
