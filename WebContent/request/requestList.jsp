...
<body>
	...
	<%if("admin".equals(article.getWriter())) {%>
	<td align="center" width="100">
		<a href="mailto:<%=article.getEmail() %>">운영자</a></td>
	<%}else{%>
	<td align="center" width="100">
...
<%
		...
		<table class="search" style="border: hidden;">
			<form name="searchForm" action="searchList.jsp">
				<tr> 
				...
				<td><input type="text" size = "20" name="condition" border="0" /></td>
