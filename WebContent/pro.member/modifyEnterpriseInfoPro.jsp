			...
			<tr>
				<td colspan="2">
					<table class="">
                    	...
                    	<tr>
                    	    <td class="">업태</td>
                    	    <td colspan="2"><%=dto.getEp_type() %></td>
                		</tr>
                		<tr>
                    		<td class="">이메일</td>
						...
						<tr>
							<td>
				 			<hr class="">
				 			<input class="" type="button" value="확인" onclick="location.href = '/animal/form.member/loginEnterpriseForm.jsp'"/>
						</td>
					</tr>
				</table>
			</td>
